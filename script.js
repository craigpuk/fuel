...
function performCalculations(data) {
  try {
    ...
    const nAir_total = (totalO2Required) / O2_fraction; // mol/s
    ...
    // Recalculate total air based on fuel flow
    const nAir = nAir_total * nFuel; // mol/s
    ...
    const nO2Excess = (nAir * O2_fraction) - stoichAir * nFuel; // mol/s
